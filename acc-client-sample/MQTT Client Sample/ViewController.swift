...
class ViewController: UIViewController {
    ...
    private let connectionString = "HostName=yizhon-test-iot.azure-devices.net;DeviceId=ios-test;SharedAccessKey=hoDqYKsXYlvhzeVSad4yTUh6eH9YSeHpszluFOCKfFw="
    ...
    override func viewDidLoad() {
        ...
        timer = Timer.scheduledTimer(timeInterval: 3.0, target: self, selector: #selector(ViewController.updateAcc), userInfo: nil, repeats: true)
    }
    ...
    @IBOutlet weak var lblLastAcc: UILabel!
    
    var cntSent = 0
    var cntGood: Int = 0
    var cntBad = 0
    var cntRcvd = 0
    var accReading: String!
    ...
    @objc func updateAcc() {
        ...
        accReading = String(describing: accelerometerData)
        lblLastAcc.text = accReading
    ...
    let myReceiveMessageCallback: IOTHUB_CLIENT_MESSAGE_CALLBACK_ASYNC = { message, userContext in
        ...
        if rc == IOTHUB_MESSAGE_OK {
            ...
            mySelf.lblLastAcc.text = messageString
        }
        else {
